...
val SecretEntranceTest by testSuite {
    ...
    test("part 1: the password to open the door") {
        SecretEntrance().part1(input) shouldBe 3
    }

    test("part 2: the password to open the door with method 0x434C49434B") {
        SecretEntrance().part2(input) shouldBe 6
    }

    test("part 2 with 2x overflow") {
        SecretEntrance().part2(listOf("L200")) shouldBe 2
    }

    test("part 2 with 2x underflow") {
        SecretEntrance().part2(listOf("R200")) shouldBe 2
    }

    test("part 2 with an exact 0 and 2x overflow") {
        SecretEntrance().part2(listOf("L50", "L200")) shouldBe 3
    }

    test("part 2 with an exact 0 and 2x underflow") {
        SecretEntrance().part2(listOf("L50", "R200")) shouldBe 3
    }

    test("part 2 with an exact 0 and 2x overflow not landing on 0") {
        SecretEntrance().part2(listOf("L50", "L199")) shouldBe 2
    }

    test("part 2 with an exact 0 and 2x underflow not landing on 0") {
