...
val WizardSimulator20XXTest by testSuite {

    test("can parse the input") {
        val input = listOf(
            "Hit Points: 50",
            "Damage: 5",
        )
    ...
    test("the player wins in the first example") {
    ...
    test("the player wins in the second example") {
        val playerStats = PlayerStats(10, 250)
    ...
    test("part1: the player wins with the calculated spells") {
    ...
    test("part 1: the least amount of mana to win the fight") {
        val input = listOf(
            "Hit Points: 14",
            "Damage: 9",
        )
    ...
    test("part 2: the least amount of mana to win the fight on hard difficulty") {
        val input = listOf(
            "Hit Points: 14",
            "Damage: 9",
        )
