...
val ItHangsInTheBalanceTest by testSuite {

    test("input can be parsed") {
        listOf("1", "2", "3").parseWeights() shouldBe listOf(1, 2, 3)
    }

    test("When grouping the example into 3 groups of equal weight, there is a unique group 1 of minimal weight") {
    ...
    test("the quantum entanglement is the product of all weights in a group") {
    ...
    test("part 1 (three groups of equal weight): in the example, the packages 11 and 9 win") {
        val input = listOf("1", "2", "3", "4", "5", "7", "8", "9", "10", "11")
        ItHangsInTheBalance().part1(input) shouldBe 99
    }

    test("part 2 (four groups of equal weight): in the example, the packages 11 and 4 win") {
        val input = listOf("1", "2", "3", "4", "5", "7", "8", "9", "10", "11")
