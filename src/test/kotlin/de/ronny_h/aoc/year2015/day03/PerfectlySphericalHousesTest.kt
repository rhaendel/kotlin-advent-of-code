...
val PerfectlySphericalHousesTest by testSuite {

    test("part 1: Santa delivers at least one present to a number of houses") {
    ...
    test("part 2: Santa and Robo-Santa deliver at least one present to a number of houses") {
