...
val RPGSimulator20XXTest by testSuite {
    ...
    test("the player wins in the given example") {
    ...
    test("part 1: the min cost to win - a Dagger for 8 is enough") {
        val input = listOf(
            "Hit Points: 100",
            "Damage: 1",
            "Armor: 1",
    ...
    test("part 2: the max cost to loose - a Dagger and a Damage +1 ring") {
        val input = listOf(
            "Hit Points: 100",
            "Damage: 3",
            "Armor: 3",
