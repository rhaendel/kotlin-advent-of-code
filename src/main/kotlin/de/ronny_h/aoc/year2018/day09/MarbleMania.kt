...
fun main() = MarbleMania().run(413188, 0)

class MarbleMania : AdventOfCode<Long>(2018, 9) {
    ...
    private fun playTheGame(numberOfMarbles: Int, numberOfPlayers: Int): Long {
        val circle = MutableRingList<Int>()
        circle.insert(0)
        val scores = mutableMapOf<Int, Long>().withDefault { 0 }
        var player = 1
