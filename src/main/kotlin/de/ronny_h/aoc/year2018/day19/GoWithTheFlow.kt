...
class GoWithTheFlow : AdventOfCode<Int>(2018, 19) {
    ...
    override fun part1(input: List<String>): Int = WristDeviceWithFlowControl(input).runProgram()

    override fun part2(input: List<String>): Int = WristDeviceWithFlowControl(input, 1).runProgram()
